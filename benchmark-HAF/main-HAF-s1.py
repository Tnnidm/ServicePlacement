...
'''
# dqn = dqn.DQN()
Agent = control_group.HAF1.HAF(a_dim)
...
for Date in range(1012, 1013):
    ...
    for t in range(0, SLOTNUM):
        ...
        IDNE_num = np.sum(a)
        request_num_writer.writerow([Date, t, count, IDNE_num*(2*1910-IDNE_num+1)/2])
...
for Date in range(1012, 1013):
    ...
    for t in range(0, SLOTNUM):
        ...
        #     a_t = copy.deepcopy(aa).numpy()
        #     a = aa[0,:1910].numpy()
        aa, count = Agent.choose_action_statistic(env, 1009, t)
