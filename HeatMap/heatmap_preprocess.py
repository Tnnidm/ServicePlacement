...
def add_args():
    ...
    parser.add_argument('--dataset', type=str, default='chengdushi_1010_1020.csv',
...
if "_10" in args.dataset:
    ...
    min_time = 1538336145.0+599*4320     #最小时间，也就是我们认为1101的0时所在的时间
    min_date = 1101           #最小日期
...
f = open('dict_Car_1012.txt','w+')   #把字典存在txt文件里
f.write(str(dict_Car[1012]))
f.close()