...
filelist=GetPyFile(sourcefolder)
for file in filelist:
    old_pos = sourcefolder+'/'+file
...
for Date in (list(range(1008,1032))+list(range(1001,1008))):
    print('Date = '+str(Date))
